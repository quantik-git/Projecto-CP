...
%
     \ensuremath{\begin{lcbr}(\Varid{q}\;\Varid{d})\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{0}}\\(\Varid{q}\;\Varid{d})\comp \succ \;\Varid{n}\mathrel{=}\mathbf{if}\;(\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d})\;\Varid{n}\;\mathbf{then}\;\succ \comp (\Varid{q}\;\Varid{d})\;\Varid{n}\;\mathbf{else}\;(\Varid{q}\;\Varid{d})\;\Varid{n}\end{lcbr}}
%
\just\equiv{ def-cond }
%
     \ensuremath{\begin{lcbr}(\Varid{q}\;\Varid{d})\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{0}}\\(\Varid{q}\;\Varid{d})\comp \succ \;\Varid{n}\mathrel{=}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d})\to \succ \comp (\Varid{q}\;\Varid{d}),(\Varid{q}\;\Varid{d}))\;\Varid{n}\end{lcbr}}
%
\just\equiv{ igualdade extensional, eq-x, fusão-x }
%
     \ensuremath{(\Varid{q}\;\Varid{d})\comp \alt{\underline{\mathrm{0}}}{\succ }\mathrel{=}[\mskip1.5mu \underline{\mathrm{0}},((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d})\to \succ \comp (\Varid{q}\;\Varid{d}),(\Varid{q}\;\Varid{d}))\mskip1.5mu]}
%
\just\equiv{ def-in, def condicional de McCarthy }
%
     \ensuremath{(\Varid{q}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\mathrm{0}},[\mskip1.5mu \succ \comp (\Varid{q}\;\Varid{d}),(\Varid{q}\;\Varid{d})\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\mathbin{?}\mskip1.5mu]}
%
\just\equiv{ natural-id, absorção-+ }
%
     \ensuremath{(\Varid{q}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\mathrm{0}},[\mskip1.5mu \succ \comp (\Varid{q}\;\Varid{d}),(\Varid{q}\;\Varid{d})\mskip1.5mu]\mskip1.5mu]\comp (\Varid{id}\mathbin{+}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\mathbin{?})}
\qed
\end{eqnarray*}
...
%
     \ensuremath{\begin{lcbr}(\Varid{r}\;\Varid{d})\comp \underline{\mathrm{0}}\mathrel{=}\underline{\mathrm{0}}\\(\Varid{r}\;\Varid{d})\comp \succ \;\Varid{n}\mathrel{=}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d})\to \underline{\mathrm{0}},\succ \comp (\Varid{r}\;\Varid{d}))\;\Varid{n}\end{lcbr}}
%
\just\equiv{ igualdade extensional, eq-x, fusão-x, def-in }
%
     \ensuremath{(\Varid{r}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\mathrm{0}},((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d})\to \underline{\mathrm{0}},\succ \comp (\Varid{r}\;\Varid{d}))\mskip1.5mu]}
%
\just\equiv{ def condicional de McCarthy, natural-id }
%
     \ensuremath{(\Varid{r}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\mathrm{0}}\comp \Varid{id},[\mskip1.5mu \underline{\mathrm{0}},\succ \comp (\Varid{r}\;\Varid{d})\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\mathbin{?}\mskip1.5mu]}
%
\just\equiv{ absorção-+ }
%
     \ensuremath{(\Varid{r}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\mathrm{0}},[\mskip1.5mu \underline{\mathrm{0}},\succ \comp (\Varid{r}\;\Varid{d})\mskip1.5mu]\mskip1.5mu]\comp (\Varid{id}\mathbin{+}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\mathbin{?})}
\qed
\end{eqnarray*}
...
%
     \ensuremath{\begin{lcbr}(\Varid{c}\;\Varid{d})\comp \underline{\mathrm{0}}\mathrel{=}\underline{\Varid{d}}\\(\Varid{c}\;\Varid{d})\comp \succ \;\Varid{n}\mathrel{=}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d})\to \underline{\Varid{d}},\Varid{pred}\comp (\Varid{c}\;\Varid{d}))\;\Varid{n}\end{lcbr}}
%
\just\equiv{ igualdade extensional, eq-x, fusão-x, def-in }
%
     \ensuremath{(\Varid{c}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\Varid{d}},((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d})\to \underline{\Varid{d}},\Varid{pred}\comp (\Varid{c}\;\Varid{d}))\mskip1.5mu]}
%
\just\equiv{ def condicional de McCarthy, natural-id }
%
     \ensuremath{(\Varid{c}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\Varid{d}}\comp \Varid{id},[\mskip1.5mu \underline{\Varid{d}},\Varid{pred}\comp (\Varid{c}\;\Varid{d})\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\mathbin{?}\mskip1.5mu]}
%
\just\equiv{ absorção-+ }
%
     \ensuremath{(\Varid{c}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\Varid{d}},[\mskip1.5mu \underline{\Varid{d}},\Varid{pred}\comp (\Varid{c}\;\Varid{d})\mskip1.5mu]\mskip1.5mu]\comp (\Varid{id}\mathbin{+}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\mathbin{?})}
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\start
     \ensuremath{\begin{lcbr}(\Varid{q}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\mathrm{0}},[\mskip1.5mu \succ \comp (\Varid{q}\;\Varid{d}),(\Varid{q}\;\Varid{d})\mskip1.5mu]\mskip1.5mu]\comp (\Varid{id}\mathbin{+}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\mathbin{?})\\(\Varid{r}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\mathrm{0}},[\mskip1.5mu \underline{\mathrm{0}},\succ \comp (\Varid{r}\;\Varid{d})\mskip1.5mu]\mskip1.5mu]\comp (\Varid{id}\mathbin{+}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\mathbin{?})\\(\Varid{c}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\Varid{d}},[\mskip1.5mu \underline{\Varid{d}},\Varid{pred}\comp (\Varid{c}\;\Varid{d})\mskip1.5mu]\mskip1.5mu]\comp (\Varid{id}\mathbin{+}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\mathbin{?})\end{lcbr}}
%
\just\equiv{ def condicional de McCarthy, natural-id }
%
     \ensuremath{(\Varid{c}\;\Varid{d})\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \underline{\Varid{d}}\comp \Varid{id},[\mskip1.5mu \underline{\Varid{d}},\Varid{pred}\comp (\Varid{c}\;\Varid{d})\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}))\mathbin{?}\mskip1.5mu]}
...
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \Conid{F}\;\Varid{bob}\\\Varid{bob}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \Conid{F}\;\Varid{alice}\end{lcbr}}
%
\just\equiv{ def-out }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\comp \Varid{out}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \Conid{F}\;\Varid{bob}\comp \Varid{out}\\\Varid{bob}\comp \mathbf{in}\comp \Varid{out}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \Conid{F}\;\Varid{alice}\comp \Varid{out}\end{lcbr}}
%
\just\equiv{ in . out = id }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \Conid{F}\;\Varid{bob}\comp \Varid{out}\\\Varid{bob}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \Conid{F}\;\Varid{alice}\comp \Varid{out}\end{lcbr}}
%
\just\equiv{ eq-x }
%
     \ensuremath{\conj{\Varid{alice}}{\Varid{bob}}\mathrel{=}\conj{[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \Conid{F}\;\Varid{bob}\comp \Varid{out}}{[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \Conid{F}\;\Varid{alice}\comp \Varid{out}}}
\qed
\end{eqnarray*}
...
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \p2\comp \conj{\Conid{F}\;\Varid{alice}}{\Conid{F}\;\Varid{bob}}\\\Varid{bob}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \p1\comp \conj{\Conid{F}\;\Varid{alice}}{\Conid{F}\;\Varid{bob}}\end{lcbr}}
%
\just\equiv{ fokkinga }
%
