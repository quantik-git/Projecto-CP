...
%
     \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{alice}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{a}\\\Varid{alice}\;(\Conid{Fork}\;(\Varid{l},\Varid{r}))\mathrel{=}\uncurry{\Varid{max}}\comp (\Varid{bob}\;\Varid{x}\;\Varid{bob})\;(\Varid{l},\Varid{r})\end{lcbr}\\\begin{lcbr}\Varid{bob}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{a}\\\Varid{bob}\;(\Conid{Fork}\;(\Varid{l},\Varid{r}))\mathrel{=}\uncurry{\Varid{min}}\comp (\Varid{alice}\;\Varid{x}\;\Varid{alice})\;(\Varid{l},\Varid{r})\end{lcbr}\end{lcbr}}
%
\just\equiv{ natural-id, igualdade extensional }
%
     \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{alice}\comp \Conid{Leaf}\mathrel{=}\Varid{id}\\\Varid{alice}\comp \Conid{Fork}\mathrel{=}\uncurry{\Varid{max}}\comp (\Varid{bob}\;\Varid{x}\;\Varid{bob})\end{lcbr}\\\begin{lcbr}\Varid{bob}\comp \Conid{Leaf}\mathrel{=}\Varid{id}\\\Varid{bob}\comp \Conid{Fork}\mathrel{=}\uncurry{\Varid{min}}\comp (\Varid{alice}\;\Varid{x}\;\Varid{alice})\end{lcbr}\end{lcbr}}
%
\just\equiv{ eq-+, fusão-+ }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp [\mskip1.5mu \Conid{Leaf},\Conid{Fork}\mskip1.5mu]\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\comp (\Varid{bob}\;\Varid{x}\;\Varid{bob})\mskip1.5mu]\\\Varid{bob}\comp [\mskip1.5mu \Conid{Leaf},\Conid{Fork}\mskip1.5mu]\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\comp (\Varid{alice}\;\Varid{x}\;\Varid{alice})\mskip1.5mu]\end{lcbr}}
%
\just\equiv{ def-in, natural-id }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id}\comp \Varid{id},\uncurry{\Varid{max}}\comp (\Varid{bob}\;\Varid{x}\;\Varid{bob})\mskip1.5mu]\\\Varid{bob}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id}\comp \Varid{id},\uncurry{\Varid{min}}\comp (\Varid{alice}\;\Varid{x}\;\Varid{alice})\mskip1.5mu]\end{lcbr}}
%
\just\equiv{ absorção-+ }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}(\Varid{bob}\;\Varid{x}\;\Varid{bob}))\\\Varid{bob}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}(\Varid{alice}\;\Varid{x}\;\Varid{alice}))\end{lcbr}}
%
...
\qed
\end{eqnarray*}
E assim podemos definir o \start{ \ensuremath{\Varid{both}} } como um \start{ \ensuremath{\conj{\Varid{alice}}{\Varid{bob}}} }
...
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \p2\comp \conj{\fun F \;\Varid{alice}}{\fun F \;\Varid{bob}}\\\Varid{bob}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \p1\comp \conj{\fun F \;\Varid{alice}}{\fun F \;\Varid{bob}}\end{lcbr}}
%
\just\equiv{ fokkinga }
%
     \ensuremath{\conj{\Varid{alice}}{\Varid{bob}}\mathrel{=}\llparenthesis\, \conj{[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \p2}{[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \p1}\,\rrparenthesis}
\qed
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  bflip :: Bit -> Dist Bit}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  bflip 0 = D[(0,0.96), (1,0.04)]}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  bflip 1 = D[(1,0.90), (0,0.10)]}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bflip3}\mathbin{::}\Conid{Bit3}\to \fun{Dist}\;\Conid{Bit3}{}\<[E]%
\\
\>[B]{}\Varid{bflip3}\;\Varid{t}\mathord{@}(\Varid{a},\Varid{b},\Varid{c})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \bot \mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
