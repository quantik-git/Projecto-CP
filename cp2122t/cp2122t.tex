...
Pretendemos demonstrar que \start{ \ensuremath{\Varid{loop}\;\Varid{d}\mathrel{=}\Varid{aux}\;\Varid{d}} }. Para tal começamos por trabalhar na 
seguinte equação.
...
\begin{eqnarray}
\start
     \ensuremath{\begin{lcbr}(\Varid{q}\;\Varid{d})\comp \mathbf{in}\mathrel{=}\Varid{f}\comp \fun F \;\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\\(\Varid{r}\;\Varid{d})\comp \mathbf{in}\mathrel{=}\Varid{g}\comp \fun F \;\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\\(\Varid{c}\;\Varid{d})\comp \mathbf{in}\mathrel{=}\Varid{h}\comp \fun F \;\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\end{lcbr}}
%
\equiv{ \ensuremath{\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}}\mathrel{=}\cataList{\conj{\Varid{f}}{\conj{\Varid{g}}{\Varid{h}}}}} }
\just\equiv{ definição de in; functor dos naturais; def-aux }
%
     \ensuremath{\begin{lcbr}(\Varid{q}\;\Varid{d})\comp \alt{\underline{\mathrm{0}}}{\succ }\mathrel{=}\Varid{f}\comp (\Varid{id}\mathbin{+}\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}})\\(\Varid{r}\;\Varid{d})\comp \alt{\underline{\mathrm{0}}}{\succ }\mathrel{=}\Varid{g}\comp (\Varid{id}\mathbin{+}\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}})\\(\Varid{c}\;\Varid{d})\comp \alt{\underline{\mathrm{0}}}{\succ }\mathrel{=}\Varid{h}\comp (\Varid{id}\mathbin{+}\conj{\Varid{q}\;\Varid{d}}{\conj{\Varid{r}\;\Varid{d}}{\Varid{c}\;\Varid{d}}})\end{lcbr}}
%
\equiv { \ensuremath{\Varid{aux}\;\Varid{d}\mathrel{=}\cataList{\conj{\Varid{f}}{\conj{\Varid{g}}{\Varid{h}}}}} }
\just\equiv{ fusão-+; reflexão-+; eq-+; igualdade extensional; def-comp; def-split; def-x }
%
     \ensuremath{\begin{lcbr}\begin{lcbr}(\Varid{q}\;\Varid{d})\;\mathrm{0}\mathrel{=}\Varid{a}\\(\Varid{q}\;\Varid{d})\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}f_2 \;(\Varid{q}\;\Varid{d}\;\Varid{n},(\Varid{r}\;\Varid{d}\;\Varid{n},\Varid{c}\;\Varid{d}\;\Varid{n}))\end{lcbr}\\\begin{lcbr}(\Varid{r}\;\Varid{d})\;\mathrm{0}\mathrel{=}\Varid{b}\\(\Varid{r}\;\Varid{d})\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}g_2 \;(\Varid{q}\;\Varid{d}\;\Varid{n},(\Varid{r}\;\Varid{d}\;\Varid{n},\Varid{c}\;\Varid{d}\;\Varid{n}))\end{lcbr}\\\begin{lcbr}(\Varid{c}\;\Varid{d})\;\mathrm{0}\mathrel{=}\Varid{c}\\(\Varid{c}\;\Varid{d})\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}h_2 \;(\Varid{q}\;\Varid{d}\;\Varid{n},(\Varid{r}\;\Varid{d}\;\Varid{n},\Varid{c}\;\Varid{d}\;\Varid{n}))\end{lcbr}\end{lcbr}}
%
\equiv{ \ensuremath{\Varid{aux}\;\Varid{d}\mathrel{=}\cataList{\conj{\alt{\underline{\Varid{a}}}{f_2 }}{\conj{\alt{\underline{\Varid{b}}}{g_2 }}{\alt{\underline{\Varid{c}}}{h_2 }}}}} }
%
\end{eqnarray}
...
\>[B]{}\Varid{q}\;\Varid{d}\;\mathrm{0}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{q}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{q}\;\Varid{d}\;\Varid{n}\mathbin{+}(\mathbf{if}\;(\Varid{c}\;\Varid{d}\;\Varid{n})\equiv \mathrm{0}\;\mathbf{then}\;\mathrm{1}\;\mathbf{else}\;\mathrm{0}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{eqnarray}
\start
     \ensuremath{\begin{lcbr}\Varid{q}\;\Varid{d}\;\mathrm{0}\mathrel{=}\mathrm{0}\\\Varid{q}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{q}\;\Varid{d}\;\Varid{n}\mathbin{+}(\mathbf{if}\;(\Varid{c}\;\Varid{d}\;\Varid{n})\equiv \mathrm{0}\;\mathbf{then}\;\mathrm{1}\;\mathbf{else}\;\mathrm{0})\end{lcbr}}
%
\just\equiv{ def-succ; 1ª lei de fusão do condicional }
%
     \ensuremath{\begin{lcbr}\Varid{q}\;\Varid{d}\;\mathrm{0}\mathrel{=}\mathrm{0}\\\Varid{q}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathbf{if}\;(\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}\;\Varid{n})\;\mathbf{then}\;\succ \comp (\Varid{q}\;\Varid{d}\;\Varid{n})\;\mathbf{else}\;(\Varid{q}\;\Varid{d}\;\Varid{n})\end{lcbr}}
%
\just\equiv{ def-cond }
%
     \ensuremath{\begin{lcbr}\Varid{q}\;\Varid{d}\;\mathrm{0}\mathrel{=}\mathrm{0}\\\Varid{q}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}\;\Varid{n})\to \succ \comp (\Varid{q}\;\Varid{d}\;\Varid{n}),(\Varid{q}\;\Varid{d}\;\Varid{n}))\end{lcbr}}
%
\just\equiv{ def condicional de McCarthy }
%
     \ensuremath{\begin{lcbr}\Varid{q}\;\Varid{d}\;\mathrm{0}\mathrel{=}\mathrm{0}\\\Varid{q}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}[\mskip1.5mu \succ \comp (\Varid{q}\;\Varid{d}\;\Varid{n}),(\Varid{q}\;\Varid{d}\;\Varid{n})\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}\;\Varid{n}))\mathbin{?}\end{lcbr}}
%
\end{eqnarray}
...
\>[B]{}\Varid{r}\;\Varid{d}\;\mathrm{0}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{r}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathbf{if}\;(\Varid{c}\;\Varid{d}\;\Varid{n})\equiv \mathrm{0}\;\mathbf{then}\;\mathrm{0}\;\mathbf{else}\;\mathrm{1}\mathbin{+}\Varid{r}\;\Varid{d}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{eqnarray}
\start
     \ensuremath{\begin{lcbr}\Varid{r}\;\Varid{d}\;\mathrm{0}\mathrel{=}\mathrm{0}\\\Varid{r}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathbf{if}\;(\Varid{c}\;\Varid{d}\;\Varid{n})\equiv \mathrm{0}\;\mathbf{then}\;\mathrm{0}\;\mathbf{else}\;\mathrm{1}\mathbin{+}\Varid{r}\;\Varid{d}\;\Varid{n}\end{lcbr}}
%
\just\equiv{ def-succ; def-cond }
%
     \ensuremath{\begin{lcbr}\Varid{r}\;\Varid{d}\;\mathrm{0}\mathrel{=}\mathrm{0}\\\Varid{r}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}\;\Varid{n})\to \underline{\mathrm{0}},\succ \comp (\Varid{r}\;\Varid{d}\;\Varid{n}))\;\Varid{n}\end{lcbr}}
%
\just\equiv{ def condicional de McCarthy }
%
     \ensuremath{\begin{lcbr}\Varid{r}\;\Varid{d}\;\mathrm{0}\mathrel{=}\mathrm{0}\\\Varid{r}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}[\mskip1.5mu \underline{\mathrm{0}},\succ \comp (\Varid{r}\;\Varid{d}\;\Varid{n})\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}\;\Varid{n}))\mathbin{?}\end{lcbr}}
%
\end{eqnarray}
...
\>[B]{}\Varid{c}\;\Varid{d}\;\mathrm{0}\mathrel{=}\Varid{d}{}\<[E]%
\\
\>[B]{}\Varid{c}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathbf{if}\;(\Varid{c}\;\Varid{d}\;\Varid{n})\equiv \mathrm{0}\;\mathbf{then}\;\Varid{d}\;\mathbf{else}\;(\Varid{c}\;\Varid{d}\;\Varid{n})\mathbin{-}\mathrm{1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
\begin{eqnarray}
\start
     \ensuremath{\begin{lcbr}\Varid{c}\;\Varid{d}\;\mathrm{0}\mathrel{=}\Varid{d}\\\Varid{c}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathbf{if}\;(\Varid{c}\;\Varid{d}\;\Varid{n})\equiv \mathrm{0}\;\mathbf{then}\;\Varid{d}\;\mathbf{else}\;(\Varid{c}\;\Varid{d}\;\Varid{n})\mathbin{-}\mathrm{1}\end{lcbr}}
%
\just\equiv{ def-pred; def-cond }
%
     \ensuremath{\begin{lcbr}\Varid{c}\;\Varid{d}\;\mathrm{0}\mathrel{=}\Varid{d}\\\Varid{c}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}\;\Varid{n})\to \underline{\Varid{d}},\Varid{pred}\comp (\Varid{c}\;\Varid{d}\;\Varid{n}))\end{lcbr}}
%
\just\equiv{ def condicional de McCarthy }
%
     \ensuremath{\begin{lcbr}\Varid{c}\;\Varid{d}\;\mathrm{0}\mathrel{=}\Varid{d}\\\Varid{c}\;\Varid{d}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}[\mskip1.5mu \underline{\Varid{d}},\Varid{pred}\comp (\Varid{c}\;\Varid{d}\;\Varid{n})\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp (\Varid{c}\;\Varid{d}\;\Varid{n}))\mathbin{?}\end{lcbr}}
%
\end{eqnarray}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{a}\mathrel{=}\Varid{b}\mathrel{=}\mathrm{0}{}\<[E]%
\\
\>[B]{}\Varid{c}\mathrel{=}\Varid{d}{}\<[E]%
\\
\>[B]{}f_2 \mathrel{=}[\mskip1.5mu \succ \comp \p1,\p1\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp \p2\comp \p2)\mathbin{?}{}\<[E]%
\\
\>[B]{}g_2 \mathrel{=}[\mskip1.5mu \underline{\mathrm{0}},\succ \comp \p1\comp \p2\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp \p2\comp \p2)\mathbin{?}{}\<[E]%
\\
\>[B]{}h_2 \mathrel{=}[\mskip1.5mu \underline{\Varid{d}},\Varid{pred}\comp \p2\comp \p2\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp \p2\comp \p2)\mathbin{?}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\start
%
     \ensuremath{\Varid{aux}\;\Varid{d}\mathrel{=}\cataList{\conj{\alt{\underline{\mathrm{0}}}{f_2 }}{\conj{\alt{\underline{\mathrm{0}}}{g_2 }}{\alt{\underline{\Varid{d}}}{h_2 }}}}}
%
\just\equiv{ def-for }
%
     \ensuremath{\Varid{aux}\;\Varid{d}\mathrel{=}\for{\conj{f_2 }{\conj{g_2 }{h_2 }}}\ {(\underline{\mathrm{0}},\underline{\mathrm{0}},\underline{\Varid{d}})}}
%
\end{eqnarray*}

\newpage

Neste ponto já estámos bastante próximos da definição do \start{ \ensuremath{\Varid{loop}\;\Varid{d}} } basta-nos demonstrar
a igualdade entre \start{ \ensuremath{\Varid{g}\;\Varid{d}} } e \start{ \ensuremath{\conj{f_2 }{\conj{g_2 }{h_2 }}} }

\begin{eqnarray*}
\start
%
     \ensuremath{\Varid{g}\;\Varid{d}\mathrel{=}\conj{f_2 }{\conj{g_2 }{h_2 }}}
%
\just\equiv{ def-g2; def-h2 }
%
     \ensuremath{\Varid{g}\;\Varid{d}\mathrel{=}\conj{f_2 }{\conj{[\mskip1.5mu \underline{\mathrm{0}},\succ \comp \p1\comp \p2\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp \p2\comp \p2)\mathbin{?}}{[\mskip1.5mu \underline{\Varid{d}},\Varid{pred}\comp \p2\comp \p2\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp \p2\comp \p2)\mathbin{?}}}}
%
\just\equiv{ fusão-x; }
%
     \ensuremath{\Varid{g}\;\Varid{d}\mathrel{=}\conj{f_2 }{\conj{[\mskip1.5mu \underline{\mathrm{0}},\succ \comp \p1\comp \p2\mskip1.5mu]}{[\mskip1.5mu \underline{\Varid{d}},\Varid{pred}\comp \p2\comp \p2\mskip1.5mu]}\comp (((\mathrm{0}\equiv )\comp \p2\comp \p2)\mathbin{?})}}
%
\just\equiv{ lei de troca; def-f2; fusão-x }
%
     \ensuremath{\Varid{g}\;\Varid{d}\mathrel{=}\conj{[\mskip1.5mu \succ \comp \p1,\p1\mskip1.5mu]}{[\mskip1.5mu \conj{\underline{\mathrm{0}}}{\underline{\Varid{d}}},\conj{\succ \comp \p1\comp \p2}{\Varid{pred}\comp \p2\comp \p2}\mskip1.5mu]}\comp ((\mathrm{0}\equiv )\comp \p2\comp \p2)\mathbin{?}}
%
\just\equiv{ lei da troca; igualdade extensional }
%
     \ensuremath{\Varid{g}\;\Varid{d}\;(\Varid{q},(\Varid{r},\Varid{c}))\mathrel{=}[\mskip1.5mu \conj{\succ \comp \p1}{\conj{\underline{\mathrm{0}}}{\underline{\Varid{d}}}},\conj{\p1}{\conj{\succ \comp \p1\comp \p2}{\Varid{pred}\comp \p2\comp \p2}}\mskip1.5mu]\comp ((\mathrm{0}\equiv )\comp \p2\comp \p2)\mathbin{?}(\Varid{q},(\Varid{r},\Varid{c}))}
%
\just\equiv{ 2ª lei de fusão do condicional }
%
     \ensuremath{\Varid{g}\;\Varid{d}\;(\Varid{q},(\Varid{r},\Varid{c}))\mathrel{=}[\mskip1.5mu \conj{\succ \;\Varid{q}}{\conj{\underline{\mathrm{0}}}{\underline{\Varid{d}}}},\conj{\Varid{q}}{\conj{\succ \;\Varid{r}}{\Varid{pred}\;\Varid{c}}}\mskip1.5mu]\comp (\mathrm{0}\equiv \Varid{c})\mathbin{?}}
%
\just\equiv{ def-split }
%
     \ensuremath{\Varid{g}\;\Varid{d}\;(\Varid{q},(\Varid{r},\Varid{c}))\mathrel{=}[\mskip1.5mu (\succ \;\Varid{q},(\underline{\mathrm{0}},\underline{\Varid{d}})),(\Varid{q},(\succ \;\Varid{r},\Varid{pred}\;\Varid{c}))\mskip1.5mu]\comp (\mathrm{0}\equiv \Varid{c})\mathbin{?}}
%
\just\equiv{ eq-+??? }
%
     \ensuremath{\begin{lcbr}\Varid{g}\;\Varid{d}\;(\Varid{q},(\Varid{r},\mathrm{0}))\mathrel{=}(\succ \;\Varid{q},(\underline{\mathrm{0}},\underline{\Varid{d}}))\\\Varid{g}\;\Varid{d}\;(\Varid{q},(\Varid{r},\Varid{c}))\mathrel{=}(\Varid{q},(\succ \;\Varid{r},\Varid{pred}\;\Varid{c}))\end{lcbr}}
%
\just\equiv{ def-succ, def-pred }
%
     \ensuremath{\begin{lcbr}\Varid{g}\;\Varid{d}\;(\Varid{q},(\Varid{r},\mathrm{0}))\mathrel{=}(\Varid{q}\mathbin{+}\mathrm{1},(\mathrm{0},\Varid{d}))\\\Varid{g}\;\Varid{d}\;(\Varid{q},(\Varid{r},\Varid{c}))\mathrel{=}(\Varid{q},(\Varid{r}\mathbin{+}\mathrm{1},\Varid{c}\mathbin{-}\mathrm{1}))\end{lcbr}}
%
\qed
\end{eqnarray*}
...
\begin{eqnarray*}
\xymatrix@C=2cm{
     \ensuremath{\N_0\mathbin{+}({\LTree}\;\N_0)}^2
          \ar[d]^-{\ensuremath{\fun F \;\Varid{bob}}}
&
&
     \ensuremath{{\LTree}\;\N_0}
          \ar[d]^{\ensuremath{\conj{\Varid{alice}}{\Varid{bob}}}}
          \ar[ll]_-{\ensuremath{\Varid{out}}}
          \ar[dl]_-{\ensuremath{\Varid{alice}}}
          \ar[rr]^-{\ensuremath{\Varid{out}}}
          \ar[dr]^-{\ensuremath{\Varid{bob}}}
&
&
     \ensuremath{\N_0\mathbin{+}({\LTree}\;\N_0)}^2
          \ar[d]_-{\ensuremath{\fun F \;\Varid{alice}}}
\\
     \ensuremath{\N_0\mathbin{+}\N_0\times\N_0}
          \ar[r]_-{\ensuremath{\alt{\Varid{id}}{\uncurry{\Varid{max}}}}}
&
     \ensuremath{\N_0}
&
...
&
     \ensuremath{\N_0\mathbin{+}\N_0\times\N_0}
          \ar[l]^-{\ensuremath{\alt{\Varid{id}}{\uncurry{\Varid{min}}}}}
}
\end{eqnarray*} 

\begin{eqnarray*}
\start
     \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{alice}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{a}\\\Varid{alice}\;(\Conid{Fork}\;(\Varid{l},\Varid{r}))\mathrel{=}\Varid{max}\;(\Varid{bob}\;\Varid{l})\;(\Varid{bob}\;\Varid{r})\end{lcbr}\\\begin{lcbr}\Varid{bob}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{a}\\\Varid{bob}\;(\Conid{Fork}\;(\Varid{l},\Varid{r}))\mathrel{=}\Varid{min}\;(\Varid{alice}\;\Varid{l})\;(\Varid{alice}\;\Varid{r})\end{lcbr}\end{lcbr}}
%
\just\equiv{ uncurry, def-x }
%
     \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{alice}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{a}\\\Varid{alice}\;(\Conid{Fork}\;(\Varid{l},\Varid{r}))\mathrel{=}\uncurry{\Varid{max}}\comp (\Varid{bob}\times\Varid{bob})\;(\Varid{l},\Varid{r})\end{lcbr}\\\begin{lcbr}\Varid{bob}\;(\Conid{Leaf}\;\Varid{a})\mathrel{=}\Varid{a}\\\Varid{bob}\;(\Conid{Fork}\;(\Varid{l},\Varid{r}))\mathrel{=}\uncurry{\Varid{min}}\comp (\Varid{alice}\times\Varid{alice})\;(\Varid{l},\Varid{r})\end{lcbr}\end{lcbr}}
%
\just\equiv{ natural-id, igualdade extensional }
%
     \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{alice}\comp \Conid{Leaf}\mathrel{=}\Varid{id}\\\Varid{alice}\comp \Conid{Fork}\mathrel{=}\uncurry{\Varid{max}}\comp (\Varid{bob}\times\Varid{bob})\end{lcbr}\\\begin{lcbr}\Varid{bob}\comp \Conid{Leaf}\mathrel{=}\Varid{id}\\\Varid{bob}\comp \Conid{Fork}\mathrel{=}\uncurry{\Varid{min}}\comp (\Varid{alice}\times\Varid{alice})\end{lcbr}\end{lcbr}}
%
\just\equiv{ eq-+, fusão-+ }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp [\mskip1.5mu \Conid{Leaf},\Conid{Fork}\mskip1.5mu]\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\comp (\Varid{bob}\times\Varid{bob})\mskip1.5mu]\\\Varid{bob}\comp [\mskip1.5mu \Conid{Leaf},\Conid{Fork}\mskip1.5mu]\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\comp (\Varid{alice}\times\Varid{alice})\mskip1.5mu]\end{lcbr}}
%
\just\equiv{ def-in, natural-id }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id}\comp \Varid{id},\uncurry{\Varid{max}}\comp (\Varid{bob}\times\Varid{bob})\mskip1.5mu]\\\Varid{bob}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id}\comp \Varid{id},\uncurry{\Varid{min}}\comp (\Varid{alice}\times\Varid{alice})\mskip1.5mu]\end{lcbr}}
%
\just\equiv{ absorção-+ }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}(\Varid{bob}\times\Varid{bob}))\\\Varid{bob}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp (\Varid{id}\mathbin{+}(\Varid{alice}\times\Varid{alice}))\end{lcbr}}
%
\just\equiv{ def-functor }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \fun F \;\Varid{bob}\\\Varid{bob}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \fun F \;\Varid{alice}\end{lcbr}}
%
\just\equiv{ def-out }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\comp \Varid{out}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \fun F \;\Varid{bob}\comp \Varid{out}\\\Varid{bob}\comp \mathbf{in}\comp \Varid{out}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \fun F \;\Varid{alice}\comp \Varid{out}\end{lcbr}}
%
\just\equiv{ in . out = id }
%
     \ensuremath{\begin{lcbr}\Varid{alice}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \fun F \;\Varid{bob}\comp \Varid{out}\\\Varid{bob}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \fun F \;\Varid{alice}\comp \Varid{out}\end{lcbr}}
%
\just\equiv{ eq-x }
%
     \ensuremath{\conj{\Varid{alice}}{\Varid{bob}}\mathrel{=}\conj{[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \fun F \;\Varid{bob}\comp \Varid{out}}{[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \fun F \;\Varid{alice}\comp \Varid{out}}}
\qed
\end{eqnarray*}
E assim podemos definir o \start{ \ensuremath{\Varid{both}} } como \start{ \ensuremath{\conj{\Varid{alice}}{\Varid{bob}}} }
...
&
     \ensuremath{\N_0\mathbin{+}({\LTree}\;\N_0)}^2
          \ar[d]^-{\ensuremath{\fun F \;\Varid{both}}}
\\
     \ensuremath{\N_0\times\N_0}
&
     \ensuremath{\N_0\mathbin{+}(\N_0\times\N_0)}^2
          \ar[l]^-{\ensuremath{\conj{\alt{\Varid{id}}{\uncurry{\Varid{max}}}\comp \fun F \;\p2}{\alt{\Varid{id}}{\uncurry{\Varid{min}}}\comp \fun F \;\p1}}}
}
\end{eqnarray*} 
...
%
     \ensuremath{\begin{lcbr}\Varid{alice}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \fun F \;\p2\comp \fun F \;\conj{\Varid{alice}}{\Varid{bob}}\\\Varid{bob}\comp \mathbf{in}\mathrel{=}[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \fun F \;\p1\comp \fun F \;\conj{\Varid{alice}}{\Varid{bob}}\end{lcbr}}
%
\just\equiv{ fokkinga }
%
     \ensuremath{\conj{\Varid{alice}}{\Varid{bob}}\mathrel{=}\llparenthesis\, \conj{[\mskip1.5mu \Varid{id},\uncurry{\Varid{max}}\mskip1.5mu]\comp \fun F \;\p2}{[\mskip1.5mu \Varid{id},\uncurry{\Varid{min}}\mskip1.5mu]\comp \fun F \;\p1}\,\rrparenthesis}
\qed
\end{eqnarray*}
...
\\
\>[B]{}\Varid{alice}\mathrel{=}\alt{\Varid{id}}{\Varid{umax}}\comp \Varid{recLTree}\;\Varid{bob}\comp \mathsf{out}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bob}\mathbin{::}\Conid{Ord}\;\Varid{c}\Rightarrow {\LTree}\;\Varid{c}\to \Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{bob}{}\<[7]%
\>[7]{}\mathrel{=}\alt{\Varid{id}}{\Varid{umin}}\comp \Varid{recLTree}\;\Varid{alice}\comp \mathsf{out}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{both}\mathbin{::}\Conid{Ord}\;\Varid{d}\Rightarrow {\LTree}\;\Varid{d}\to (\Varid{d},\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{both}{}\<[7]%
\>[7]{}\mathrel{=}\conj{\Varid{alice}}{\Varid{bob}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{both'}\mathbin{::}\Conid{Ord}\;\Varid{d}\Rightarrow {\LTree}\;\Varid{d}\to (\Varid{d},\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{both'}\mathrel{=}\llparenthesis\, \conj{\Varid{a}}{\Varid{b}}\,\rrparenthesis\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{a}\mathrel{=}\alt{\Varid{id}}{\Varid{umax}}\comp \Varid{recLTree}\;\p2{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{b}\mathrel{=}\alt{\Varid{id}}{\Varid{umin}}\comp \Varid{recLTree}\;\p1{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=4cm{
     \ensuremath{\Conid{Tri}\times\N_0}
          \ar[dd]_-{\ensuremath{\Varid{geraSierp}}}
          \ar[r]^-{\ensuremath{g_2 }}
&
     \ensuremath{\Conid{Tri}\mathbin{+}(\Conid{Tri}\times\N_0)}^3
          \ar[dd]^-{\ensuremath{\fun F \;\Varid{geraSierp}}}
\\
\\
     \ensuremath{\mathsf{LTree3}\;\Conid{Tri}}
          \ar@/^2pc/[r]^(0.45){\ensuremath{\Varid{out}}}
          \ar[dd]_-{\ensuremath{\Varid{folhasSierp}}}
&
     \ensuremath{\mathsf{LTree3}\;\Conid{Tri}\mathbin{+}(\mathsf{LTree3}\;\Conid{Tri})}^3
          \ar[dd]^-{\ensuremath{\fun F \;\Varid{folhasSierp}}}
          \ar@/^2pc/[l]^(0.45){\ensuremath{\mathbf{in}}}
\\
\\
     \ensuremath{\lambda [\mskip1.5mu \Conid{Tri}\lambda \mskip1.5mu]}
&
     \ensuremath{\Conid{Tri}\mathbin{+}\Conid{Tri}}^3
          \ar[l]^-{\ensuremath{\alt{\Varid{singl}}{\mathsf{conc}\comp (\mathsf{conc}\times\Varid{id})}}}
}
\end{eqnarray*} 
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{ns}\mathrel{=}\Varid{s}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t1}\mathrel{=}(((\Varid{x},\Varid{y}),\Varid{ns}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t2}\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{ns},\Varid{y}),\Varid{ns}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t3}\mathrel{=}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{ns}),\Varid{ns}),\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g2'}\mathbin{::}(\Conid{Tri},\Conid{Int})\to \Conid{Tri}+(((\Conid{Tri},\Conid{Int}),(\Conid{Tri},\Conid{Int})),(\Conid{Tri},\Conid{Int})){}\<[E]%
\\
\>[B]{}\Varid{g2'}\mathrel{=}\p1+\conj{\conj{\Varid{t1}}{\Varid{t2}}}{\Varid{t3}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{ns}\mathrel{=}\uncurry{\cdot \div \cdot }\comp \conj{\Varid{id}}{\underline{\mathrm{2}}}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{nx}\mathrel{=}\Varid{add}\comp \conj{\Varid{ns}\comp \p2}{\p1\comp \p1}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{ny}\mathrel{=}\Varid{add}\comp \conj{\Varid{ns}\comp \p2}{\p2\comp \p1}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t1}\mathrel{=}((\Varid{id}\times\Varid{ns})\times\Varid{pred}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t2}\mathrel{=}(\conj{\conj{\Varid{nx}}{\p2\comp \p1}}{\Varid{ns}\comp \p2}\times\Varid{pred}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{t3}\mathrel{=}(\conj{\conj{\p1\comp \p1}{\Varid{ny}}}{\Varid{ns}\comp \p2}\times\Varid{pred}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}g_2 \;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{na}\leftarrow (\Varid{f}\;\Varid{a});\Varid{nb}\leftarrow \Varid{b};\Varid{return}\;(\Varid{na}\mathbin{:}\Varid{nb})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}g_2 \;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{na}\leftarrow (\Varid{f}\;(\Varid{a},\Varid{a},\Varid{a}));\Varid{nb}\leftarrow \Varid{b};\Varid{return}\;(v_3 \;(\Varid{na})\mathbin{:}\Varid{nb})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
